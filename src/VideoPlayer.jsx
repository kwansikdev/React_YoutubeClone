...
const VideoPlayer = props => {
  ...
  // 해당 Video의 Channel정보를 담을 state를 설정
  ...
  // location.search에 있는 값을 가져와 youtube Video 플레이 주소를 가져온다.
  ...
  // videoId를 가지고 해당 video의 정보를 API 요청
  ...
  // 해당 video의 정보에서 channelId를 가지고 해당 video의 channel 정보를 API 요청
  ...
  // rendering 되면서 딱 한번만 해당 video 데이터 API 요청
  useEffect(() => {
    getYoutubeVideoData(videoId);
  }, []);

  // video 데이터중에서 channelId 값이 변경 되었을 경우에만 해당 video의 channel 데이터 API 요청
  useEffect(() => {
